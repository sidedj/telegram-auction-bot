...
def load_config():
    ...
    YOOMONEY_SECRET = os.getenv("YOOMONEY_SECRET", "SaTKEuJWPVXJl/JFpXDCHZ4q")
    YOOMONEY_NOTIFICATION_URL = os.getenv("YOOMONEY_NOTIFICATION_URL", "http://212.111.81.230:8080/yoomoney")
